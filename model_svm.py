...
+ [Aug 3 2020] Created to replace the deprecated svm model module from semester
1. This is a greatly simplified version, retaining only the essential elements
of the code. 
- [Aug 3 2020] Removed LaTeX text rendering 
+ [27 Aug 2020] Added cross validation.
+ [27 Aug 2020] Added learning curve.
...
def generate_learning_curve(X, Y):
    ...
    ax.plot(train_sizes, test_scores_mean, 'o-', color="g",
                 label="Test score (5-fold cross-validated)")
    ax.legend()
...
# Fit regressor
regr = svm.SVR(kernel='rbf', C=16, gamma=0.22)
